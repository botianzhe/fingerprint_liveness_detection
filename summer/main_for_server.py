...
def extract_train_images():
     ...
     for filenames in os.listdir('/home/amax/Programming/Data/LivDet2013/Training/Swipe/Live/'):
          img1 = cv2.imread("/home/amax/Programming/Data/LivDet2013/Training/Swipe/Live/"+filenames, cv2.IMREAD_GRAYSCALE)
     ...
     for filenames in os.listdir('/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/BodyDouble'):
          img1 = cv2.imread("/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/BodyDouble/"+filenames, cv2.IMREAD_GRAYSCALE)
          res1 = cv2.resize(img1, (IMAGE_SIZE, IMAGE_SIZE))
          res1_1 = res1.reshape(1, IMAGE_PIXELS) / 255
          res1_1_1 = res1_1.tolist()
          train_set_x.append(res1_1_1)

     for filenames in os.listdir('/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/Latex'):
          img1 = cv2.imread("/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/Latex/"+filenames, cv2.IMREAD_GRAYSCALE)
          res1 = cv2.resize(img1, (IMAGE_SIZE, IMAGE_SIZE))
          res1_1 = res1.reshape(1, IMAGE_PIXELS) / 255
          res1_1_1 = res1_1.tolist()
          train_set_x.append(res1_1_1)

     for filenames in os.listdir('/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/Playdoh'):
          img1 = cv2.imread("/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/Playdoh/"+filenames, cv2.IMREAD_GRAYSCALE)
          res1 = cv2.resize(img1, (IMAGE_SIZE, IMAGE_SIZE))
          res1_1 = res1.reshape(1, IMAGE_PIXELS) / 255
          res1_1_1 = res1_1.tolist()
          train_set_x.append(res1_1_1)

     for filenames in os.listdir('/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/WoodGlue'):
          img1 = cv2.imread("/home/amax/Programming/Data/LivDet2013/Training/Swipe/Spoof/WoodGlue/"+filenames, cv2.IMREAD_GRAYSCALE)
          res1 = cv2.resize(img1, (IMAGE_SIZE, IMAGE_SIZE))
          res1_1 = res1.reshape(1, IMAGE_PIXELS) / 255
          res1_1_1 = res1_1.tolist()
          train_set_x.append(res1_1_1)
     ...
     npdata = npdata.reshape(2200, IMAGE_SIZE, IMAGE_SIZE, 1)
     return npdata
